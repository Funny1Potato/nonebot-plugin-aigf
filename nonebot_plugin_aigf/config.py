...
class Config(BaseModel):
    ...
    aigf_search_api: str = Field("tavily", description="搜索API: tavily/duckduckgo/bing")
    aigf_search_api_key: str = Field("", description="搜索 API Key（tavily/bing 模式必填，duckduckgo 无需）")
